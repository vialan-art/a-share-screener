...
class RollingBacktest:
    ...
    def _monthly_rebalance_dates(self, start_date: str, end_date: str, all_snapshot_dates: List[str]) -> List[str]:
        """生成每月第一个交易日的调仓日（必须是快照日）。"""
        ...
        while current <= end:
            ...
            if candidate and candidate <= end_date:
    ...
    def run(
        ...
        rebalance_dates = self._monthly_rebalance_dates(start_date, end_date, all_dates)
        if len(rebalance_dates) < 2:
            return {"error": "可调仓日期不足，需要至少两个月"}
        ...
        return {
            ...
            "strategy": {
                ...
                "annualized_return": _annualized(strategy_returns),
            ...
            "random": {
                ...
                "annualized_return": _annualized(random_returns),
            ...
            "benchmark": {
                ...
                "annualized_return": _annualized(benchmark_returns),
